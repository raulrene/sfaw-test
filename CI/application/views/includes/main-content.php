        ...
        <article class="testimonial">
            <div class="testimonial-image">
                <div class="bubble-image">
                    <img width="264" height="264" src="<?php echo base_url().$row->img;?>" class="attachment-small wp-post-image" alt="avatar_27">
                    <div class="substrate">
                        <img src="<?php echo base_url();?>assets/img/testBubble.png" alt="">
                    </div>
                </div>
            </div>
