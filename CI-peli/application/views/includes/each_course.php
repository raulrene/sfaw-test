<div class = "column">
    <div class="column-content">
        ...
        <div class="col-img">
            <a href="#">
                <img  alt="<?php echo $c->img_alt; ?>" src="<?php echo base_url().$c->course_img; ?>">
            </a>
        </div>
        ...
        <div class="col-txt">
            ...
            <footer class="crs-footer">
                <div class="crs-user"><img src="<?php echo base_url(); ?>assets/img/user_icon.png" alt="user"/> <?php  echo $c->course_user; ?></div>
                <div class="crs-star">
                    <?php
                    for($n=0;$n<5;$n++){
                        if($n<$c->course_stars){?>
