...
CREATE TABLE `configurare` (
  ...
  `font_family` varchar(1500) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `configurare`
--

LOCK TABLES `configurare` WRITE;
/*!40000 ALTER TABLE `configurare` DISABLE KEYS */;
/*!40000 ALTER TABLE `configurare` ENABLE KEYS */;
UNLOCK TABLES;
